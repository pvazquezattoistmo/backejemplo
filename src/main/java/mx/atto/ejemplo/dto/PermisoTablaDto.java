 ...
 * @author IstmoSoft
 */
public class PermisoTablaDto implements Serializable {
...
// atributos fin
    ...
    public PermisoTablaDto toDefault( ) {
     return this;      }


// constructores inicio
     public PermisoTablaDto() {
     }
     public PermisoTablaDto( Integer id,  String etiqueta,  java.lang.Integer permiso,  String tabla,  java.lang.Integer status,  Set<PerfilDto> perfiles,  UsuarioDto usuarioUltMov,  UsuarioDto usuario) {
...
// seters fin
   public static PermisoTablaDto fromEntidad(PermisoTabla PEentidad){
	   PermisoTablaDto salida = new PermisoTablaDto();
   ...
   public  PermisoTabla toEntidadBase(){
	   PermisoTablaDto PEentidad = this;	   PermisoTabla salida = new PermisoTabla();
	   salida.setId(PEentidad.getId());  
	   salida.setEtiqueta(PEentidad.getEtiqueta());  
	   salida.setPermiso(PEentidad.getPermiso());  
	   salida.setTabla(PEentidad.getTabla());  
   ...
   public  PermisoTabla toEntidad(){
	   PermisoTablaDto PEentidad = this;	   PermisoTabla salida = PEentidad.toEntidadBase();
   ...
   public String toString(){
	   String salida="Tabla PermisoTabla \n";
           salida+= "id = "+ this.id +"\n";
