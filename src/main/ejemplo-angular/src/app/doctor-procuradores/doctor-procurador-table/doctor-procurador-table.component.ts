...
@Component({
    ...
    templateUrl: './doctor-procurador-table.component.html',
    styleUrls: ['./doctor-procurador-table.component.css'],
    providers:[GlobalesService, 
               PermisoAtributoService,
               PermisoTablaService,
               ] 
})
export class DoctorProcuradorTableComponent implements OnInit {
    public primero: boolean = true;
    public doctorProcuradorSeleccionado: DoctorProcurador;
    ...
    constructor(public globalesService: GlobalesService,
        ...
        this.doctorProcuradorSeleccionado = new DoctorProcurador();
        ...
        var tabla = $('#tabla_doctorProcurador').DataTable({
            ...
            "initComplete": function(settings, json) {
                ...
                $($(xs[0]).find(".col-sm-6")[0]).
                    ...
                    .click(function() {
                        self.doctorProcuradorSeleccionado = new DoctorProcurador();
                        self.primero = false;
                    });
            },
            "ajax": {
    ...
    cambio_doctorProcurador(doctorProcurador) {
