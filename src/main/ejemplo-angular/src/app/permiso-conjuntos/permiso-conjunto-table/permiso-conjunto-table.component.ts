...
@Component({
    ...
    templateUrl: './permiso-conjunto-table.component.html',
    styleUrls: ['./permiso-conjunto-table.component.css'],
    providers:[GlobalesService, 
               PermisoAtributoService,
               PermisoTablaService,
               ] 
})
export class PermisoConjuntoTableComponent implements OnInit {
    public primero: boolean = true;
    public permisoConjuntoSeleccionado: PermisoConjunto;
    ...
    constructor(public globalesService: GlobalesService,
        ...
        this.permisoConjuntoSeleccionado = new PermisoConjunto();
        ...
        var tabla = $('#tabla_permisoConjunto').DataTable({
            ...
            "initComplete": function(settings, json) {
                ...
                $($(xs[0]).find(".col-sm-6")[0]).
                    ...
                    .click(function() {
                        self.permisoConjuntoSeleccionado = new PermisoConjunto();
                        self.primero = false;
                    });
            },
            "ajax": {
    ...
    cambio_permisoConjunto(permisoConjunto) {
