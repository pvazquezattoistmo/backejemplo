...
@Component({
    ...
    templateUrl: './dato-cornea-extraccion-table.component.html',
    styleUrls: ['./dato-cornea-extraccion-table.component.css'],
    providers:[GlobalesService, 
               PermisoAtributoService,
               PermisoTablaService,
               ] 
})
export class DatoCorneaExtraccionTableComponent implements OnInit {
    public primero: boolean = true;
    public datoCorneaExtraccionSeleccionado: DatoCorneaExtraccion;
    ...
    constructor(public globalesService: GlobalesService,
        ...
        this.datoCorneaExtraccionSeleccionado = new DatoCorneaExtraccion();
        ...
        var tabla = $('#tabla_datoCorneaExtraccion').DataTable({
            ...
            "initComplete": function(settings, json) {
                ...
                $($(xs[0]).find(".col-sm-6")[0]).
                    ...
                    .click(function() {
                        self.datoCorneaExtraccionSeleccionado = new DatoCorneaExtraccion();
                        self.primero = false;
                    });
            },
            "ajax": {
    ...
    cambio_datoCorneaExtraccion(datoCorneaExtraccion) {
