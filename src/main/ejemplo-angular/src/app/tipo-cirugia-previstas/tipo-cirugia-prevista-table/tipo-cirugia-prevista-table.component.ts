...
@Component({
    ...
    templateUrl: './tipo-cirugia-prevista-table.component.html',
    styleUrls: ['./tipo-cirugia-prevista-table.component.css'],
    providers:[GlobalesService, 
               PermisoAtributoService,
               PermisoTablaService,
               ] 
})
export class TipoCirugiaPrevistaTableComponent implements OnInit {
    public primero: boolean = true;
    public tipoCirugiaPrevistaSeleccionado: TipoCirugiaPrevista;
    ...
    constructor(public globalesService: GlobalesService,
        ...
        this.tipoCirugiaPrevistaSeleccionado = new TipoCirugiaPrevista();
        ...
        var tabla = $('#tabla_tipoCirugiaPrevista').DataTable({
            ...
            "initComplete": function(settings, json) {
                ...
                $($(xs[0]).find(".col-sm-6")[0]).
                    ...
                    .click(function() {
                        self.tipoCirugiaPrevistaSeleccionado = new TipoCirugiaPrevista();
                        self.primero = false;
                    });
            },
            "ajax": {
    ...
    cambio_tipoCirugiaPrevista(tipoCirugiaPrevista) {
