...
@Component({
    ...
    templateUrl: './equipo-extraccion-table.component.html',
    styleUrls: ['./equipo-extraccion-table.component.css'],
    providers:[GlobalesService, 
               PermisoAtributoService,
               PermisoTablaService,
               ] 
})
export class EquipoExtraccionTableComponent implements OnInit {
    public primero: boolean = true;
    public equipoExtraccionSeleccionado: EquipoExtraccion;
    ...
    constructor(public globalesService: GlobalesService,
        ...
        this.equipoExtraccionSeleccionado = new EquipoExtraccion();
        ...
        var tabla = $('#tabla_equipoExtraccion').DataTable({
            ...
            "initComplete": function(settings, json) {
                ...
                $($(xs[0]).find(".col-sm-6")[0]).
                    ...
                    .click(function() {
                        self.equipoExtraccionSeleccionado = new EquipoExtraccion();
                        self.primero = false;
                    });
            },
            "ajax": {
    ...
    cambio_equipoExtraccion(equipoExtraccion) {
