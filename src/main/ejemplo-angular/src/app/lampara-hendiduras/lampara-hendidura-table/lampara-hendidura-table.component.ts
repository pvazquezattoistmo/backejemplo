...
@Component({
    ...
    templateUrl: './lampara-hendidura-table.component.html',
    styleUrls: ['./lampara-hendidura-table.component.css'],
    providers:[GlobalesService, 
               PermisoAtributoService,
               PermisoTablaService,
               ] 
})
export class LamparaHendiduraTableComponent implements OnInit {
    public primero: boolean = true;
    public lamparaHendiduraSeleccionado: LamparaHendidura;
    ...
    constructor(public globalesService: GlobalesService,
        ...
        this.lamparaHendiduraSeleccionado = new LamparaHendidura();
        ...
        var tabla = $('#tabla_lamparaHendidura').DataTable({
            ...
            "initComplete": function(settings, json) {
                ...
                $($(xs[0]).find(".col-sm-6")[0]).
                    ...
                    .click(function() {
                        self.lamparaHendiduraSeleccionado = new LamparaHendidura();
                        self.primero = false;
                    });
            },
            "ajax": {
    ...
    cambio_lamparaHendidura(lamparaHendidura) {
