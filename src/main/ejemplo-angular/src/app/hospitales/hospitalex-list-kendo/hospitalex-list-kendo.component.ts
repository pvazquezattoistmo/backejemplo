...
@Component({
    selector: 'app-hospitalex-list-kendo',
    templateUrl: './hospitalex-list-kendo.component.html',
    styleUrls: ['./hospitalex-list-kendo.component.css'],
    providers: [
//             PermisoTablaService,
//****************************************************************************************I N I C I O    D E    O P T I M I Z A C I O N    D E    C O D I G O *****************************
                CoreService,
...
export class HospitalexListKendoComponent implements OnInit {
