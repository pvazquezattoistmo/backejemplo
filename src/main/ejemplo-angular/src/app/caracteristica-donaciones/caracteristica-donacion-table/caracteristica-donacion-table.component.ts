...
@Component({
    ...
    templateUrl: './caracteristica-donacion-table.component.html',
    styleUrls: ['./caracteristica-donacion-table.component.css'],
    providers:[GlobalesService, 
               PermisoAtributoService,
               PermisoTablaService,
               ] 
})
export class CaracteristicaDonacionTableComponent implements OnInit {
    public primero: boolean = true;
    public caracteristicaDonacionSeleccionado: CaracteristicaDonacion;
    ...
    constructor(public globalesService: GlobalesService,
        ...
        this.caracteristicaDonacionSeleccionado = new CaracteristicaDonacion();
        ...
        var tabla = $('#tabla_caracteristicaDonacion').DataTable({
            ...
            "initComplete": function(settings, json) {
                ...
                $($(xs[0]).find(".col-sm-6")[0]).
                    ...
                    .click(function() {
                        self.caracteristicaDonacionSeleccionado = new CaracteristicaDonacion();
                        self.primero = false;
                    });
            },
            "ajax": {
    ...
    cambio_caracteristicaDonacion(caracteristicaDonacion) {
