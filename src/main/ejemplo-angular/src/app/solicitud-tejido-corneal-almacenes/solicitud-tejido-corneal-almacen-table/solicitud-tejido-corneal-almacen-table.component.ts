...
@Component({
    ...
    templateUrl: './solicitud-tejido-corneal-almacen-table.component.html',
    styleUrls: ['./solicitud-tejido-corneal-almacen-table.component.css'],
    providers:[GlobalesService, 
               PermisoAtributoService,
               PermisoTablaService,
               ] 
})
export class SolicitudTejidoCornealAlmacenTableComponent implements OnInit {
    public primero: boolean = true;
    public solicitudTejidoCornealAlmacenSeleccionado: SolicitudTejidoCornealAlmacen;
    ...
    constructor(public globalesService: GlobalesService,
        ...
        this.solicitudTejidoCornealAlmacenSeleccionado = new SolicitudTejidoCornealAlmacen();
        ...
        var tabla = $('#tabla_solicitudTejidoCornealAlmacen').DataTable({
            ...
            "initComplete": function(settings, json) {
                ...
                $($(xs[0]).find(".col-sm-6")[0]).
                    ...
                    .click(function() {
                        self.solicitudTejidoCornealAlmacenSeleccionado = new SolicitudTejidoCornealAlmacen();
                        self.primero = false;
                    });
            },
            "ajax": {
    ...
    cambio_solicitudTejidoCornealAlmacen(solicitudTejidoCornealAlmacen) {
